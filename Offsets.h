...
//	static const uint64_t BuffManager = (uint64_t)0x27B0;        //    [[[[<league of Legends.exe> + 0x21AD080]+ 0x27C8] + 0x00] + 0x10] + 0x8
...
/*13.18.530.4653*/
#define oRenderer 0x21F50D0	//48 8B 0D ? ? ? ? 4C 8D 44 24 ? 48 8B D0 
#define oViewProjMatrices 0x21EC740	//4C 8D 05 ? ? ? ? 48 8D 54 24 ? 48 8B 48 08
#define oChatClient 0x21A5820	//48 8B 0D ? ? ? ? E8 ? ? ? ? 80 BF ? ? ? ? ? 75 23
#define oLocalPlayer 0x21A56F8	//48 8B 05 ? ? ? ? 48 85 C9 0F 84 ? ? ? ? 
#define oGameTime 0x2198714	//F3 0F 5C 35 ? ? ? ? 0F 28 F8 
#define oTurretList 0x2192BC0	//48 8B 0D ? ? ? ? 48 89 74 24 ? E8 ? ? ? ? 48 8B F0 48 85 C0 74 6E 
#define oMinionList 0x218C328	//4C 8B 05 ? ? ? ? 49 8B 78 08 41 8B 40 10 48 8D 0C C7 48 3B F9 73 47 48 39 1F 74 0B 48 83 C7 08 48 3B F9 72 F2 EB 37 48 83 C1 F8 48 3B F9 73 1E 48 2B CF 48 89 74 24 ? 48 FF C9 48 8D 77 08 48 C1 E9 03 48 FF C1 F3 48 A5 48 8B 74 24 ? 41 FF 48 10 48 8B D3 49 8B 00 49 8B C8 FF 50 10 48 8B 83 ? ? ? ? 
#define oHeroList 0x21894B0	//48 8B 05 ? ? ? ? 4D 89 7B D8 48 85 C0
#define oHudInstance 0x21893A0	//48 8B 0D ?? ?? ?? ?? 48 89 5C 24 ?? 48 8B 59 60
#define oPingNet 0x2189388	//48 8B 0D ? ? ? ? 48 8D 55 C7
#define oDerefPointer 0x102A5F0	//E8 ? ? ? ? 48 8B C8 E8 ? ? ? ? 80 3B 00
#define oTryRightClick 0x88CA30	//48 89 5C 24 ? 57 48 83 EC 50 48 8B D9 0F 29 74 24 ? 48 8B 0D ? ? ? ?
#define oAttackMove 0x88C880	//48 83 EC 48 8B 42 48 45 33 C9 C6 44 24 ? ? 41 B0 01
#define oPrintChat 0x847F20	//E8 ? ? ? ? 4C 8B C3 B2 01 
#define oSendChat 0x83AF85	//E9 ? ? ? ? CC CC CC CC CC CC 48 8B 0D ? ? ? ? E9 ? ? ? ?
#define oGetAttackDelay 0x3B64A0	//F3 0F 10 89 ? ? ? ? E9 ? ? ? ?
#define oGetAttackWindup 0x3B63A0	//E8 ? ? ? ? 48 8B CE F3 0F 11 83 ? ? ? ? 
#define oGetBoundingRadius 0x1FB700	//E8 ? ? ? ? 0F 28 F8 48 8B D6
...
// DXSwapChain::Present: dxgi.dll + 0x15E0;    48 89 5C 24 ? 48 89 74 24 ? 55 57 41 56 48 8D 6C 24 ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 45 60