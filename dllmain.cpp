...
__declspec(dllexport) uint64_t OnInject() {

	Sleep(100);

	volatile unsigned int signature = 0xDEADBEEF;   // C7 45 04 EF BE AD DE C7 45 24 AD DE EF BE
	volatile unsigned int signature2 = 0xBEEFDEAD;
